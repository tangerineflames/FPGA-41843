...
uart_rx #(
  ...
  .data  (uart_rx_byte)
    ...
    // ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½Ğ§ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½Â½ï¿½ï¿½Ê±ï¿½ï¿½ï¿½ï¿½
    reg in_crossing_d1;
    reg [7:0] walk_final_sec;
    reg [3:0] eff_tens, eff_ones, eff_frac;  // Ğ§ï¿½Ê²ï¿½Ö³Éµï¿½Î»ï¿½ï¿½Ê¡ï¿½ï¿?? vga_pic ï¿½ĞµÄ³ï¿½ï¿½ï¿½
    reg [9:0] eff_val;  // Ğ§ï¿½ï¿½Ğ¼ï¿½ï¿½ï¿½ï¿½
    always @(posedge vga_clk or negedge rst_n) begin
        if (!rst_n) begin
            in_crossing_d1 <= 1'b0;
            walk_final_sec <= 8'd0;
    ...
    seg7_4digit u_seg7 (
        ...
        .rst_n    (rst_n),
        .value    (green_left_s), // µ±Ç°ÂÌµÆÊ£Óà"ĞéÄâÃë" 0~99
